...
public class Player_Avro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.avro.Player_Avro.Builder newBuilder() {
    return new com.avro.Player_Avro.Builder();
  }
   ...
   * @return A new Player_Avro RecordBuilder
   */
  public static com.avro.Player_Avro.Builder newBuilder(com.avro.Player_Avro.Builder other) {
    return new com.avro.Player_Avro.Builder(other);
  }
   ...
   * @return A new Player_Avro RecordBuilder
   */
  public static com.avro.Player_Avro.Builder newBuilder(com.avro.Player_Avro other) {
    return new com.avro.Player_Avro.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Player_Avro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.avro.Player_Avro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.avro.Player_Avro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.sportName)) {
        this.sportName = data().deepCopy(fields()[0].schema(), other.sportName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.Player_Avro.Builder setSportName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.Player_Avro.Builder clearSportName() {
      sportName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.Player_Avro.Builder setJerseyNumber(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.Player_Avro.Builder clearJerseyNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.Player_Avro.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.Player_Avro.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.Player_Avro.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.Player_Avro.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.Player_Avro.Builder setHeight(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.Player_Avro.Builder clearHeight() {
